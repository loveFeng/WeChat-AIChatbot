...
class sum4all(Plugin):
    ...
    def handle_url(self, content, e_context):
        ...
        if self.url_sum_service == "openai":
            ...
            model = "gemini"
            api_base = "https://gemini.baipiao.io/v1/models/gemini-pro:generateContent?key="
        else:
    ...
    def handle_search(self, content, e_context):
        ...
        if self.search_sum_service == "openai":
            ...
            api_key = self.gemini_key
            model = "gemini"
            api_base = "https://gemini.baipiao.io/v1/models/gemini-pro:generateContent"
    ...
    def handle_image(self, base64_image, e_context):
        ...
        if self.image_sum_service == "openai":
            ...
            api_key = self.gemini_key
            api_base = "https://gemini.baipiao.io/v1/models/gemini-pro-vision:generateContent"
            payload = {
                "contents": [
                    {
                        "parts": [
